% -------------------------------------- %
% https://www.mathworks.com/matlabcentral/fileexchange/18510-matlab-performance-measurement
...
function configinfo
disp('<strong>MATLAB configuration information</strong>');
...
disp(' ');
disp('<strong>Platform created by: </strong>Matthew Hellinger (May 2023)')
disp('Algorithms primarily from <strong>Numerical Optimization 2nd Ed.</strong>')
disp('by Jorge Nocedal & Stephen J. Wright')
disp('Supplemented with public domain and open source resources')
disp('(documented in source)')